...
$(".denomination").click(function(event) {
  ...
  $("button.submit-card").text('Donate $' + $(this).children(":first").val())
  $("#price").text($(this).children(":first").val())
...
let Control = document.querySelector(".payment-form-control");
let Paypal = document.querySelector(".paypal-form-control");
//let Button = document.querySelector(".payment-form-control-button");
